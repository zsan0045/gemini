...
export async function generateContent({
  ...
  // The temperature for the model. Should be a value between 0 and 2, or
  // the max supported by the model.
  temperature = 1.0,
  ...
  // The safety settings for this request. This is a map from safety category
  // to its block threshold.
  // Valid categories: 'harassment', 'hate_speech', 'sexually_explicit',
  //                   'dangerous_content', 'civic_integrity'
  // Valid threshold: 'low_and_above', 'medium_and_above', 'only_high', 'none'
  safetySettings = new Map(),
